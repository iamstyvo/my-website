...
function PassportPayment() {
  ...
  const handleMobileMoneyPayment = (e) => {
    ...
    addEntry({
      ...
      raw: {
        ...formData,
        passportNumber: formData.passportIDNumber,
        paymentMethod: 'mobile-money',
        payerName: payerName,
        paymentPhoneNumber: '0798437286',
        paymentReceiverName: 'Niyonzimasteven'
      },
      notes: `Lost on ${new Date().toISOString()}. DOB: ${formData.dateOfBirth}, Gender: ${formData.gender}, Country: ${formData.country}. Paid via Mobile Money by ${payerName}`,
    ...
    return (
      <div className="container">
        <div className="content">
          ...
          <Link to="/passport-form" className="back-button">Go to Form</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="content">
          ...
          <div className="service-details">
            <div className="success-message">
              <p>Thank you for your payment. Your Passport recovery application has been submitted.</p>
  ...
  return (
    <div className="container">
      <div className="content">
        <h1>Payment for Passport Recovery</h1>
        <div className="service-details">
          <div className="application-summary">
            <h2>Application Summary</h2>
            <p><strong>Full Name:</strong> {formData.fullName}</p>
            <p><strong>Passport ID Number:</strong> {formData.passportIDNumber}</p>
          ...
          <form onSubmit={handlePaymentSubmit} className="payment-form">
            ...
            <div className="form-buttons">
              <Link to="/passport-form" className="back-button">Back to Form</Link>
