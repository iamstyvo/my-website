...
function NationalIDPayment() {
  ...
  const handleMobileMoneyPayment = (e) => {
    ...
    addEntry({
      ...
      notes: `Lost on ${new Date().toISOString()}. DOB: ${formData.dateOfBirth}, Gender: ${formData.gender}. Paid via Mobile Money by ${payerName}`,
    ...
    return (
      <div className="container">
        <div className="content">
          ...
          <Link to="/national-id-form" className="back-button">Go to Form</Link>
        </div>
      </div>
    );
  }
        ...
        <div className="content">
          ...
          <div className="service-details">
            <div className="success-message">
              <p>Thank you for your payment. Your National ID recovery application has been submitted.</p>
  ...
  return (
    <div className="container">
      <div className="content">
        <h1>Payment for National ID Recovery</h1>
        <div className="service-details">
          <div className="application-summary">
            <h2>Application Summary</h2>
            <p><strong>Full Name:</strong> {formData.fullName}</p>
            <p><strong>Lost ID Number:</strong> {formData.lostIDNumber}</p>
          ...
          <form onSubmit={handlePaymentSubmit} className="payment-form">
            ...
            <div className="form-buttons">
              <Link to="/national-id-form" className="back-button">Back to Form</Link>
...
export default NationalIDPayment;